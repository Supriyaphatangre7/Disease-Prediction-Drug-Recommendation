...
function Footer() {
  return (
    <footer className="footer footer-horizontal footer-center bg-[#0F8E95] text-white p-10 w-full">
      {/* Navigation Links */}
      <div className="grid grid-flow-col gap-6 text-lg">
        ...
        <a className="link link-hover hover:text-gray-300" href="/service">Services</a>
      </div>
